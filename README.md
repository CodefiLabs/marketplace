...
| [conductor](https://github.com/codefilabs/conductor) | Orchestrate multiple Claude Code tmux sessions via Telegram with AI routing | `/plugin install conductor@codefilabs` |
